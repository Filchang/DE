...
csv_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'data', 'md_account_d.csv')
...
def load_md_account_d():
    ...
    try:
        ...
        load_data_log(
            file_name='md_account_d',
            start_time=start_time,
            end_time=end_time,
            count_row=count_row,
            error_message=error_message
        )
        print(f'Successfully uploaded. table: md_account_d, rows: {count_row}')
